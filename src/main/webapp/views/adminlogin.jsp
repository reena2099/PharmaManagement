...
<body>
    <div class="updatePassword-background p-3">
        <h1 class="password-heading mb-4 text-center">Admin Login</h1>
        <div class="d-flex justify-content-center">
            <img src="https://clipground.com/images/login-logo-clipart-2.png" class=" image w-40" />
        </div>
          <form action="checkEmployee" method="post" modelAttribute="employee" id="updatePasswordForm ">  
            <div class="mb-3 pt-3 form-size ">
                <label for="newPassword" class="password-heading">USERNAME</label>
                <input type="text" id="newPassword" class="form-control w-40" name="emp_username" />
                <p id="newPasswordErrMsg"></p>
            </div>
            <div class="mb-3 form-size">
                <label for="confirmPassword" class="password-heading">PASSWORD</label>
                <input type="password" id="confirmPassword" class="form-control w-40" name="emp_password" />
