...
<body>
    ...
    <div class="entire-background  d-flex flex-column justify-content-center">
        ...
        <div class="form-container p-3">
         ...
         <div class="mb-3">
                    <label>Name: </label>   
            <input type="text" class="form-control" placeholder="Enter Name" name="cust_name" required /> 
                </div>
                
                <label>Age: </label>   
            <input type="text" class="form-control" placeholder="Enter Name" name="cust_age" required /> 
