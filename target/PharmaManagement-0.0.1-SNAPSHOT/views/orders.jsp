...
<body>
    <div class="container">
        <div class="container-wrapper">
            ...
            <h3 class="login-text"><i class="bi bi-person-circle ac-logo"></i>Orders</h3>
        
            <form>
                <c:forEach var="cart" items="${listCart}" varStatus="status">
                <div class="item">Name<input class="input" type="text" value= ${cart.med_name}></div> 
                <div class="item">Price<input class="input" type="text" value=${cart.med_price}></div>
                <div class="item">Quantity<input class="input" type="text" value= ${cart.quantity}></div>
                <div class="item">Total<input class="input" type="text" value=${cart.total}></div>
               

       <a href="display">         <div class="item submit"><button type="submit">Back</button></div></a>
                </c:forEach>
            </form>
